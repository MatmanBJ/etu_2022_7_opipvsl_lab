...
int main()
{
    ...
    struct sched_param schedualing_parameters; // struct for schedual priority MAIN THREAD
    pthread_t thread;
    ...
    pthread_getschedparam(pthread_self(), &schedualing_policy, &schedualing_parameters); // getting parameters about MAIN thread
...
void *ChildThread(void *arg)
{
    ...
    struct sched_param local_schedualing_parameters; // struct for schedual priority
    ...
    pthread_getschedparam(pthread_self(), &local_schedualing_policy, &local_schedualing_parameters); // getting parameters about CHILD thread
    ...
    << (local_schedualing_policy == SCHED_OTHER ? to_string(local_schedualing_policy) + " -- SCHED_OTHER" : "") << "\n"
